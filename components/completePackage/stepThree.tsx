    ...
    <div className="space-y-6">
      <div className="text-center space-y-4">
        ...
        <p className="text-sm sm:text-base text-muted-foreground">
          Choose 2-4 primary colors and 2-4 secondary colors for your brand
        </p>
      </div>
            ...
            <div className="grid gap-6 lg:grid-cols-2">
              ...
              <div className="space-y-4">
                <div className="text-center">
                  <h3 className="text-base font-semibold">PRIMARY COLORS</h3>
                  <p className="text-xs text-muted-foreground">Main colors that represent your brand</p>
              ...
              <div className="space-y-4">
                <div className="text-center">
                  <h3 className="text-base font-semibold">SECONDARY COLORS</h3>
                  <p className="text-xs text-muted-foreground">Supporting colors for accents and variety</p>
        ...
        <div className="text-center">
          <div className="flex flex-col sm:flex-row items-center justify-center gap-2">
            ...
            >
              ...
              Can't decide? Let Atlas AI help you
            </Button>
